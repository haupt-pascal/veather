...
export default {
  ...
  methods: {
    ...
    fetchWeather3() {
      ...
      fetch(
        `${this.url_base}/forecast?lat=${coordinates.lat}&lon=${coordinates.lon}&units=metric&appid=${this.api_key}`
      )
        .then((res) => {
          return res.json();
        })
      ...
      <div class="temperature" v-if="weather.main != undefined">
        ...
        <div class="temperature-container">
          ...
          <div class="temperature-information-container">
            <!-- Day -->
            <img
              src="@/assets/icons/sun/day.png"
              v-if="
                weather.weather[0].main.toLowerCase() == 'clear' &&
                format(new Date(dateBuilder()), 'HH') < '18'
              "
            />
            <!-- Night -->
            <img
              src="@/assets/icons/moon/night.png"
              v-if="
                weather.weather[0].main.toLowerCase() == 'clear' &&
                format(new Date(dateBuilder()), 'HH') > '18'
              "
            ...
            <!-- Cloud -->
            <img
              src="@/assets/icons/cloud/cloud_rain.png"
              v-if="weather.weather[0].main.toLowerCase() == 'shower rain'"
            />
            <img
              src="@/assets/icons/cloud/cloud_rain.png"
              v-if="
            ...
            />
            <img
              src="@/assets/icons/cloud/cloud_thunderstorm.png"
              v-if="weather.weather[0].main.toLowerCase() == 'thunderstorm'"
            />
            <img
              src="@/assets/icons/cloud/cloud_snow.png"
              v-if="weather.weather[0].main.toLowerCase() == 'thunderstorm'"
            />
            <img
              src="@/assets/icons/cloud/cloud.png"
              v-if="weather.weather[0].main.toLowerCase() == 'clouds'"
            />
            <img
              src="@/assets/icons/cloud/cloud.png"
              v-if="weather.weather[0].main.toLowerCase() == 'cloud'"
            />
            <img
              src="@/assets/icons/cloud/cloud.png"
              v-if="weather.weather[0].main.toLowerCase() == 'broken clouds'"
            />
            <img
              src="@/assets/icons/sun/day_cloudy.png"
              v-if="weather.weather[0].main.toLowerCase() == 'few clouds'"
            />
            <img
              src="@/assets/icons/sun/day_cloudy.png"
              v-if="weather.weather[0].main.toLowerCase() == 'fog'"
            />
          </div>
        </div>
      </div>
      <div class="container">
        <div class="ipsum-container" v-if="weather.main != undefined">
          ...
          <div class="weather-information-container">
            <p class="weather-information">
              sunrise:
              {{ format(new Date(weather.sys.sunrise * 1000), "HH:mm:ss") }}
            </p>
            <p class="weather-information">
              sunset:
              {{ format(new Date(weather.sys.sunset * 1000), "HH:mm:ss") }}
            </p>
          </div>
          <div class="weather-information-container">
            <p class="weather-information">
            ...
            <p class="weather-information">clouds: {{ weather.clouds.all }}%</p>
          </div>
        </div>
        <div class="ipsum-container" v-if="weather.main != undefined">
          <h3 class="ipsum-title">forecast (6-hr).</h3>
          <p class="weather-information">
            {{
              format(
                new Date(forecast.list[2].dt_txt),
        ...
        <div class="ipsum-container" v-if="weather.main != undefined">
          <h3 class="ipsum-title">forecast (24-hr).</h3>
          <p class="weather-information">
            {{
              format(
                new Date(forecast.list[8].dt_txt),
                "dd MMMM yyyy - HH:mm:ss"
              )
            }}
          </p>
        ...
        <div class="ipsum-container" v-if="weather.main != undefined">
          <h3 class="ipsum-title">forecast (48-hr).</h3>
          <p class="weather-information">
            {{
              format(
                new Date(forecast.list[16].dt_txt),
                "dd MMMM yyyy - HH:mm:ss"
              )
            }}
          </p>
